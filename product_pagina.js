...
// function deleteProduct(index) {
//     let winkelmandje = JSON.parse(localStorage.getItem('productenToegevoegd'));
//     const updatedWinkelmandje = Object.values(winkelmandje).filter(product => product.id !== index);
//     localStorage.setItem('productenToegevoegd', JSON.stringify(updatedWinkelmandje));
//     productenWinkelmandjeTonen();
//     updateTotalPrijs();
//     updateTellerCart();
// }
